...
if st.button("🌟 つぎの もんだいへ！", key="bottom_button", use_container_width=True):
    ...
    st.session_state.play_audio = "q.mp3"
    st.rerun()
むし,あたまに おおきな ハサミがあって、くぬぎの きに よくいるのは？,くわがた,🪲,kuwagata.jpg
むし,あたまに りっぱな つのが あって、むしの おうさまと よばれるのは？,かぶとむし,🪲,kabutomushi.jpg
むし,はねが あかくて、くろい てんてんが ある ちいさな むしは？,てんとうむし,🐞,tentomushi.jpg
むし,なつに みんみん と、おおきな こえで なく むしは？,せみ,🪰,semi.jpg
むし,きいろと くろの しましまの ふくを きていて、はちみつを つくるのは？,みつばち,🐝,mitsubachi.jpg
むし,おしりの ところが ぴかぴかと よるに ひかる むしは？,ほたる,🪲,hotaru.jpg
むし,はねが ひらひらと うつくしくて、おはなの みつを すうのは？,ちょうちょ,🦋,chocho.jpg
むし,あきに なると、すいすいと そらを とぶ あかい むしは？,あかとんぼ, Dragonfly,akatombo.jpg
むし,はっぱの うえに いて、りっぱな カマを もっている むしは？,かまきり,🪲,kamakiri.jpg
むし,きみどりの からだで、うしろの あしで ぴょんぴょん はねるのは？,とのさまばった,🦗,batta.jpg
